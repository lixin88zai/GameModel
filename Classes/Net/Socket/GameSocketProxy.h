...
class MsgCache : public cocos2d::Ref
{
public:
    MsgCache(unsigned nMsgId, Message *pTemplate, cocos2d::Ref *pTarget, SEL_OnMsgHandler pFunc);
    ~MsgCache();
    
    static MsgCache* create(unsigned nMsgId, Message *pTemplate, cocos2d::Ref *pTarget, SEL_OnMsgHandler pFunc);
...
class GameSocketProxy : public cocos2d::Ref, public CCGameSocket
{
public:
    GameSocketProxy();
    ~GameSocketProxy();
...
protected:
    ...
    void PushWorkQ(cocos2d::Ref *pTarget, SEL_workQHandler pFunc, void* pParam);
